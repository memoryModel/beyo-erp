...
import cn.com.beyo.erp.commons.security.Digests;
import cn.com.beyo.erp.commons.security.shiro.session.SessionDAO;
import cn.com.beyo.erp.commons.service.BaseService;
import cn.com.beyo.erp.commons.service.ServiceException;
import cn.com.beyo.erp.commons.utils.CacheUtils;
import cn.com.beyo.erp.commons.utils.Encodes;
import cn.com.beyo.erp.commons.utils.StringUtils;
import cn.com.beyo.erp.commons.web.Servlets;
import cn.com.beyo.erp.modules.sys.dao.MenuDao;
import cn.com.beyo.erp.modules.sys.dao.RoleDao;
import cn.com.beyo.erp.modules.sys.dao.UserDao;
...
import cn.com.beyo.erp.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean,SystemFacade {
	 ...
	 * */
	@Transactional(propagation = Propagation.SUPPORTS,isolation = Isolation.DEFAULT,readOnly = true)
	public List<User> findByIds(String teacherIds){
		return userDao.findByIds(teacherIds);
	}
