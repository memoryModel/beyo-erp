...
import cn.com.beyo.erp.commons.utils.Exceptions;
import cn.com.beyo.erp.commons.utils.SpringContextHolder;
...
public class LogUtils {
	...
	public static void saveLog(HttpServletRequest request, Object handler, Exception ex, String title){
		...
		if (user != null && user.getId() != null){
			...
			log.setPlatformId(UserUtils.getUser().getPlatformId());
			// 异步保存日志
