...
<body>
		<ul class="nav nav-tabs">
			...
			<li><a href="${ctx}/erp/incomeNotarize/listInfo?billStatus=3">已确认账单</a></li>
			<li class="active"><a href="${ctx}/erp/incomeNotarize/listInfoo?billStatus=2">挂起账单</a></li>
		</ul>
	<form:form id="searchForm" modelAttribute="receivableBill" action="${ctx}/erp/incomeNotarize/" method="post" class="breadcrumb form-search">
		...
		<input name="billStatus" type="hidden" value="2"/>
		<br class="ul-form">
			<li><label>订单编号：</label>
		...
		<c:forEach items="${page.list}" var="erpReceivableBill">
			<tr>
				...
				<shiro:hasPermission name="erpreceivablebill:erpReceivableBill:edit"><td>
					<a href="${ctx}/erp/incomeNotarize/billRelieve?id=${erpReceivableBill.id}&&orderId=${erpReceivableBill.order.id}">账单解挂</a>
