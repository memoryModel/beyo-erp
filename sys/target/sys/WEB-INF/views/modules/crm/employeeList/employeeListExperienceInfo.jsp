...
<ul class="nav nav-tabs">
    ...
    <ul class="nav nav-tabs">
        <li><a href="${ctx}/erp/employeeList/getEmployeeInfo?id=${employee.id}">详细信息</a></li>
        <li class="active"><a href="${ctx}/erp/employeeList/getEmployeeExperienceInfo?id=${employee.id}">资历信息</a></li>
        <li><a href="${ctx}/erp/employeeList/getEmployeeAuthenticationInfo?id=${employee.id}">认证信息</a></li>
        <li><a href="${ctx}/erp/employeeList/getEmployeeTrainInfo?id=${employee.id}">培训信息</a></li>
        <li><a href="#">派工记录</a></li>
        <li><a href="#">投诉退费记录</a></li>
    </ul></div><br/>
         <strong style="font-size: large">工作经验:</strong><br/>
    ...
    <strong style="font-size: large">培训学校:</strong><br/>
