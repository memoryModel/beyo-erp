...
<ul class="nav nav-tabs">
    <%--<li><a href="${ctx}/erp/employee/list">招工管理列表</a></li>--%>
    <li class="active"><a href="${ctx}/erp/employee/form?id=${employee.id}">招工管理<shiro:hasPermission name="erp:employee:form">${not empty employee.id?'修改':'添加'}</shiro:hasPermission></a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="employee" action="${ctx}/erp/employee/save" method="post" class="form-horizontal">
    ...
    <table>
        ...
        <tr>
            <td colspan="2">
                <div class="controls">
                    <input type="checkbox" id="checkBoxId" name="checkBoxId">指派自己为沟通人
                </div>
            </td>
        </tr>
        <tr>
