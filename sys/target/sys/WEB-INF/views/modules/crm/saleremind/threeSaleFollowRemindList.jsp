...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=4">3日应跟进</a></li>
	...
	<form:form id="searchForm" modelAttribute="sale" action="${ctx}/crm/saleRemind/followRemindList?selectDay=4" method="post" class="breadcrumb form-search">
		<ul class="ul-form">
			<li>
				<label>意向业务：</label>
