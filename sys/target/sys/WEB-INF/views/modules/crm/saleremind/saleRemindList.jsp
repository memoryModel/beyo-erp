...
<body>
	<%--<ul class="nav nav-tabs">
		<c:forEach items="${erp:getCommonsTypeList(59)}" var="commonsType" varStatus="0">
			<li><a href="">${commonsType.commonsName}</a></li>
		</c:forEach>
	</ul>--%>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/crm/saleRemind/list">今日新增</a></li>
		<li><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=4">3日应跟进</a></li>
		<li ><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=2&&tagFlag=5">5日应跟进</a></li>
		<li ><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=2">7日应跟进</a></li>
		<li ><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=7">15日应跟进</a></li>
		<li><a href="${ctx}/crm/saleRemind/monthSaleFollowList?selectDay=16">30日应跟进</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="sale" action="${ctx}/crm/saleRemind/list" method="post" class="breadcrumb form-search">
		<ul class="ul-form">
			<li>
				<label>意向业务：</label>
			...
			<%--<li>
				...
				<select name="gradeStatus" class="input-medium">
					...
					<option value="2" <c:if test="${!empty followStatus && followStatus == 2}">selected</c:if>>已跟进</option>
				</select>
			</li>--%>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="sale">
			<tr>
				...
				<td>
						${erp:getFollowStatusName(sale.followStatus)}
				</td>
				<td>
