...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/crm/customer/noFollowupCustomerList">待跟进客户</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="customer" action="${ctx}/crm/customer/noFollowupCustomerList" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns">
				...
				<input id="batchToCancel" class="btn btn-primary" type="button" value="批量撤回委派"/>
			</li>
			...
			<tr>
				...
				<td>
					<shiro:hasPermission name="crm:customer:form">
						<a name="customerForm" id="${customer.id}" href="javascript:;">撤回委派</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
	...
	<script type="text/javascript">
        ...
        $(document).find("a[name='customerForm']").each(function(){
            ...
            $('#batchToCancel').click(function () {
                ...
                top.$.jBox("iframe:/crm/customer/batchToCancel?ids="+ids,{
                    title:"批量撤回委派",
                    width:600,
                    height:300,
                    buttons:{},
