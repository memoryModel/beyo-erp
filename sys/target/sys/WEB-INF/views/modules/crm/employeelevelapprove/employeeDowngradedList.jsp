...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/crm/employeeGradeApprove/downgradedList">升降级审批</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="employeeGrade" action="${ctx}/crm/employeeGradeApprove/downgradedList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="employeeGrade">
			<tr>
				...
				<td>
					<shiro:hasPermission name="crm:employeeGradeApprove:view"><a href="${ctx}/crm/employeeGradeApprove/downgradeView?id=${employeeGrade.id}">查看</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
