...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/crm/employeeGradeApprove/upgradeApproveList">升级待审批</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="employeeGrade" action="${ctx}/crm/employeeGradeApprove/upgradeApproveSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	...
	<sys:message content="${message}"/>
		...
		<div class="control-group">
				...
				<tr>
					<td>
						<div class="control-group">
							...
							<div class="controls">
								<form:input path="gradePersonName" htmlEscape="false" maxlength="20" class="required input-large"  readonly="true" />
								<span class="help-inline"><font color="red">*</font> </span>
							</div>
						</div>
					</td>
			...
			<div class="alert alert-info">升级审批</div>
			<table>
				<tr>
					<td colspan="2">
						<div class="control-group">
