...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/crm/employeeGradeApprove/downgradeApproveList">降级待审批列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="employeeGrade" action="${ctx}/crm/employeeGradeApprove/downgradeApproveList" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="employeeGrade">
			<tr>
				...
				<td>
					<shiro:hasPermission name="crm:employeeGradeApprove:view"><a href="${ctx}/crm/employeeGradeApprove/downgradeForm?id=${employeeGrade.id}">审批</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
