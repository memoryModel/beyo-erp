...
<ul class="nav nav-tabs">
	<li><a href="${ctx}/crm/employeeGradeApprove/nopassUpgradeList">待升级列表</a></li>
</ul><br/>
<form:form id="inputForm" modelAttribute="employeeGrade" action="${ctx}/crm/employeeGradeApprove/nopassUpgradeSave" method="post" class="form-horizontal">
<form:hidden path="id"/>
		...
		<tr>
			<td>
				<div class="control-group">
					...
					<div class="controls">
						<form:input path="gradePersonName" htmlEscape="false" maxlength="20" class="required input-large" value="${userName}"/>
						<span class="help-inline"><font color="red">*</font> </span>
					</div>
				</div>
			</td>
