...
<head>
	...
	<script type="text/javascript">
		...
		/*减项添加*/
        function add1(){
            var element = $("#table1").find("tr:first");
				...
				<tr>
					...
					<td>
						<div class="control-group">
							...
							<div class="controls">
								<form:select path="employee.entry.type" class="input-large" disabled="true" >
				...
				<tr>
					<td colspan="2">
						<div class="control-group">
							...
							<div class="controls">
								<form:textarea path="remark" htmlEscape="false" maxlength="1024" rows="3" readonly="true" style="width:800px;"/>
							</div>
						</div>
					</td>
				</tr>
