...
<ul class="nav nav-tabs">
	...
	<form:form id="inputForm" modelAttribute="employeeLeave" action="${ctx}/crm/employeeLeave/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	...
	<tr>
		<div class="control-group">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" value="${employeeLeave.orderItem.order.customer.name}" id="cunNames" readonly="readonly"/>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">客户手机号码：</label>
				<div class="controls">
					<input type="text" value="${employeeLeave.orderItem.order.customer.phone}" id="cunPhone" readonly="readonly"/>
				</div>
			</div>
		</tr>
		<tr>
				<div class="control-group" style="float : left;">
					...
					<div class="controls">
						<input type="text" value="${employeeLeave.orderItem.order.skillName}" id="skillName" readonly="readonly" style="width: 200px;">
					</div>
				</div>
		</tr>
		<tr>
