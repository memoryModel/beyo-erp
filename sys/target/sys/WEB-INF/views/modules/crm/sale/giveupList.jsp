	...
	<script type="text/javascript">
		$(document).ready(function() {
            ...
            $('#batchToCancel').click(function () {
                ...
                if(confirmx('确认后，销售线索恢复到再委派线索中，确认重置？',"/crm/sale/repeatDelegate?ids="+ids)){
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/crm/sale/list?followStatus=4">已放弃线索列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="sale" action="${ctx}/crm/sale/list?followStatus=4" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li class="btns"><input id="btnSubmit" class="btn btn-primary" type="submit" value="查询"/>
				<input id="batchToCancel" class="btn btn-primary" type="button" value="重置到再委派"/>
			</li>
		...
		<c:forEach items="${page.list}" var="crmSale">
			<tr>
				...
				<td>
					...
					<a href="${ctx}/crm/sale/repeatDelegate?id=${crmSale.id}" onclick="return confirmx('确认后，销售线索恢复到再委派线索中，确认重置？', this.href)">重置到待委派</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
