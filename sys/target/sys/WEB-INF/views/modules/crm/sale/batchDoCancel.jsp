...
<body>
<form:form id="inputForm" modelAttribute="crmSale" action="${ctx}/crm/sale/batchDoCancel" method="post" class="breadcrumb form-search">
            ...
            <tr>
                <td colspan="2">
                    <div>
                        ...
                        <input type="hidden" name="delegateRecordId"  value="${delegateRecordId}">
                        <input type="hidden" name="cancelPersonId"  value="${userId}">
                        <input type="hidden" name="cancelPersonName"  value="${userName}">
        ...
        <div class="form-actions">
            <c:choose>
                <c:when test="${result == 'success'}">
                    <div id="messageBox" class="alert alert-success"><button data-dismiss="alert" class="close">×</button>批量撤回成功</div>
                </c:when>
                <c:otherwise>
                    <div id="messageBox" class="alert alert-success"><button data-dismiss="alert" class="close">×</button>批量撤回失败</div>
                </c:otherwise>
            </c:choose>
