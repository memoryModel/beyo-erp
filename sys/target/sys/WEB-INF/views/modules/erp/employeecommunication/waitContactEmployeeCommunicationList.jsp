...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/erp/employeeCommunication/list?employeeCommunication.appointStatus=2">待联系招工沟通管理表列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="employee" action="${ctx}/erp/employeeCommunication/list?employeeCommunication.appointStatus=2" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="erpEmployee">
			<tr>
				...
				<td>
					<fmt:formatDate value="${erpEmployee.employeeCommunication.appointTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
