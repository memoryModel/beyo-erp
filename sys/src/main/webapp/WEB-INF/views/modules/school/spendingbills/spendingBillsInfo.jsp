...
<body>
	...
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/erp/orderRefundBill/">支出账单列表</a></li>
		<li class="active">
			<a href="${ctx}/erp/orderRefundBill/spendingConfirm?id=${orderRefund.id}&&orderId=${orderRefund.order.id}">支出记账</a>
		</li>
	</ul></div><br/><div>

	<form:form id="inputForm" modelAttribute="orderRefund" action="${ctx}/erp/orderRefundBill/updateBillStatus?billId=${orderRefund.id}&&orderId=${orderRefund.order.id}" method="post" class="form-horizontal">
		<form:hidden path="id"/>
	...
	<strong>支出单:</strong><br/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="erp:orderRefundBill:updateBillStatus">
				<input id="btnSubmit" class="btn btn-primary" type="submit" value="确认支出"/>&nbsp;
			</shiro:hasPermission>
