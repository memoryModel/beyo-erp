...
<head>
	...
	<script type="text/javascript">
        ...
        function page(n,s){
            $("#pageNo").val(n);
            $("#pageSize").val(s);
            $("#searchForm").attr('action',"${ctx}/school/schedule/myList");
            $("#searchForm").submit();
            return false;
        }
        function submitForm(){
        ...
        function exportExcel(){
            var hdHTML = $('<input type="hidden" name="myList" value="y">')
            $("#searchForm").append(hdHTML);
...
<ul class="nav nav-tabs">
	<shiro:hasPermission name="school:schedule:myList"><li class="active"><a href="${ctx}/school/schedule/myList">我的课表</a></li></shiro:hasPermission>
	<shiro:hasPermission name="school:schedule:list"><li><a href="${ctx}/school/schedule/list">全部课表</a></li></shiro:hasPermission>
</ul>
<form:form id="searchForm" modelAttribute="classSchedule" action="${ctx}/school/schedule/myList" method="post" class="breadcrumb form-search">
