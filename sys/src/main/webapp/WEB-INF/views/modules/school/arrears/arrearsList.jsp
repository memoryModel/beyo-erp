...
<body>
	...
	<form:form id="searchForm" modelAttribute="receivableBill" action="${ctx}/erp/arrears/list" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="erpReceivableBill">
			<tr>
				...
				<td>
					<shiro:hasPermission name="erp:arrears:info"><a href="${ctx}/erp/arrears/info?id=${erpReceivableBill.id}&&orderId=${erpReceivableBill.order.id}">查看</a></shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
		</tbody>
