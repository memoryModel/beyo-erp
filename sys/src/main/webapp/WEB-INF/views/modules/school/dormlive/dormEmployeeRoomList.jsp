...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/erp/dormRoomBed/handleEmployeeLive">床位列表</a></li>
	</ul>
<form:form id="searchForm" modelAttribute="dormRoomBed" action="${ctx}/erp/dormRoomBed/handleEmployeeLive?dormEmployeeLiveId=${dormEmployeeLiveId}" method="post" class="breadcrumb form-search">
...
<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${dormRoomBedeList}" var="dormRoomBed">
			<tr>
				...
				<td>
						<shiro:hasPermission name="erp:dormEmployeeLive:saveEmployeeLive"><a class="btn btn-primary" href="${ctx}/erp/dormEmployeeLive/saveEmployeeLive?dormRoomBedId=${dormRoomBed.id}&&roomId=${dormRoomBed.dormRoom.id}&&dormEmployeeLiveId=${dormEmployeeLiveId}" onclick="return confirmx('是否确认？', this.href)">选择</a></shiro:hasPermission>
				</td>
