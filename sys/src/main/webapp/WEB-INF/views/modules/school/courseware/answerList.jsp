...
<body>
	...
	<form:form id="searchForm" modelAttribute="courseware" action="${ctx}/school/answerQuestion/list" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="schoolCourseware">
			<tr createUser="${schoolCourseware.createUser}" id="${schoolCourseware.id}">
				<td><a href="${ctx}/school/courseware/answerQuestionInfo?id=${schoolCourseware.id}">
