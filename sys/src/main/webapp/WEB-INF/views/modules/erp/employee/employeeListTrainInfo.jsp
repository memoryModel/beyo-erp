...
<ul class="nav nav-tabs">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><shiro:hasPermission name="erp:employee:getEmployeeTrainInfo"><a href="${ctx}/erp/employee/getEmployeeTrainInfo?id=${employee.id}">培训信息</a></shiro:hasPermission></li>
      <%--  <li><a href="#">派工记录</a></li>
