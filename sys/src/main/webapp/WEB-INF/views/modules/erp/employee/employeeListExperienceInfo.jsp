...
<ul class="nav nav-tabs">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><shiro:hasPermission name="erp:employee:getEmployeeExperienceInfo"><a href="${ctx}/erp/employee/getEmployeeExperienceInfo?id=${employee.id}">资历信息</a></shiro:hasPermission></li>
