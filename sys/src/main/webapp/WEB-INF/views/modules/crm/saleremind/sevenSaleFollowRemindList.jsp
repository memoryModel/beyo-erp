...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=2">7日应跟进</a></li>
		<li><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=8">15日应跟进</a></li>
		<li><a href="${ctx}/crm/saleRemind/monthSaleFollowList?selectDay=16">30应跟进</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="sale" action="${ctx}/crm/saleRemind/followRemindList?selectDay=2" method="post" class="breadcrumb form-search">
		<ul class="ul-form">
			<li>
				<label>意向业务：</label>
