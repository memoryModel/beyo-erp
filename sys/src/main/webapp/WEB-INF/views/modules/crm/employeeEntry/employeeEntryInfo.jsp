...
--%>
		<li class="active"><shiro:hasPermission name="crm:entry:info"><a href="${ctx}/crm/employeeEntry/info?id=${entry.id}">详细信息</a></li></shiro:hasPermission>
	...
	<form:form id="inputForm" modelAttribute="entry" action="${ctx}/crm/employeeEntry/saves" method="post" class="form-horizontal">
		<form:hidden path="id"/>
