			...
			<tr>
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<input  name="customer.name"  value="${crmSale.customer.name}"  class="input-large" readonly="true"/>
						</div>
					</div>
				...
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<input  name="customer.phone"  value="${crmSale.customer.phone}"  class="input-large" readonly="true"/>
						</div>
					</div>
				</td>
			</tr>
			...
			<tr>
				<td>
					<div class="control-group">
						...
						<div class="controls">
							<input  name="sale.saleDelegateRecord.saleAdviserName.name"  value="${crmSale.saleDelegateRecord.saleAdviserName.name}"  class="input-large" readonly="true"/>
						</div>
					</div>
				</td>
				<td>
