...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/crm/customer/followupCustomerList">跟进中客户</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="customer" action="${ctx}/crm/customer/followupCustomerList" method="post" class="breadcrumb form-search">
			...
			<tr>
				...
				<td>
					<shiro:hasPermission name="crm:customer:form">
						<a name="toCancel" href="javascript:;" id="${customer.id}">撤回委派</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
	...
	<script type="text/javascript">
        ...
        $('a[name="toCancel"]').each(function(){
            var id = $(this).attr("id");
            $(this).click(function () {
                top.$.jBox("iframe:/crm/customer/toCancel?id="+id,{
                    title:"撤回",
                    width:900,
                    height:500,
                    buttons:{},
