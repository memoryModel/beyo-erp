...
<body>
	...
	<form:form id="inputForm" modelAttribute="employeeGrade" action="${ctx}/crm/employeeGrade/upgradeSave" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<input  type="text"   id="employeeName" name="employeeGrade.employee.name"   class="required input-large"  placeholder="点击选择添加员工" />
					<input id="selectEmployee" class="btn btn-primary" type="button"  value="选择升级员工"/>
		...
		<div class="control-group">
			<label class="control-label">待升级基础服务技能：</label>
			<div class="controls" name="skillType">
			</div>

		</div>
		<div class="alert alert-info">升级测评</div>
		<div class="control-group">
				<div class="controls">
					<input id="skillTest" class="btn btn-primary" type="button" value="升级测评"></input>
					<span class="help-inline"><font color="red">*</font> </span>
				</div>
			<table class="table table-striped table-bordered table-condensed">
				<h6>升级后等级</h6>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="upgradeReason" class="input-large" >
		...
		<div class="form-actions">
			<shiro:hasPermission name="crm:employeeGrade:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="提交审核"/>&nbsp;</shiro:hasPermission>
	...
	<script type="text/javascript">
        ...
        $(function () {
            ...
            $("#selectEmployee").click(function () {
                ...
                jbox =  top.$.jBox.open("iframe:/crm/employeeGrade/selectEmployee?employeeId="+employeeId, "选择升级员工", 1024, 520);
            });
            $("#skillTest").click(function () {
                ...
                jbox =  top.$.jBox.open("iframe:/crm/employeeGrade/skillTest?employeeSkillId="+employeeSkillId+"&&employeeId="+employeeId, "升级测评", 700, 520);
            });
