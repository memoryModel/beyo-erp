...
<body>
<br/>
<form:form id="inputForm" modelAttribute="skillToLevel" action="#" method="post" class="form-horizontal">
	...
	<c:if test="${empty result}">
		...
		<div class="control-group">
			...
			<div class="controls">
                <%--<select id="employeeSkillSelect" class="input-large">
                    <option value="">-----------请选择-----------</option>
                    <c:forEach items="${skillToLevelList}" var="skillToLevel">
                        <option selectLevelId="${skillToLevel.levelId}" value="${skillToLevel.skillId}">${skillToLevel.serviceLevel.name}</option>
                    </c:forEach>
                </select>--%>
		...
		<div class="form-actions">
			<shiro:hasPermission name="crm:entry:employeeSkillSave">	<input id="btnSubmit" class="btn btn-primary" name="save"  type="button" value="保 存"/>&nbsp;&nbsp;
			</shiro:hasPermission>
