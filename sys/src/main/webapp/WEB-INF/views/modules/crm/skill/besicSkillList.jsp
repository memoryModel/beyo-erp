		...
		$(document).ready(function() {
			$('a[name="skillSelct"]').each(function () {
				$(this).click(function () {
                    ...
                    var category = 'besicSkill';
                    parent.window.frames["mainFrame"].skillSelectCallback(id,name,selectFlag,category);
                    if(selectFlag == '选择'){
                        $(this).text('取消选择')
					}
					if(selectFlag == '取消选择'){
...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/crm/skill/besicSkillList">技能项列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="skill" action="${ctx}/crm/skill/besicSkillList" method="post" class="breadcrumb form-search">
