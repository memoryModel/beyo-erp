...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/crm/saleRemind/list">今日跟进提醒</a></li>
		<li><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=4">3日未跟进</a></li>
		<li><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=2&&tagFlag=${tagFlag}">5日未跟进</a></li>
		<li><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=2">7日未跟进</a></li>
		<li><a href="${ctx}/crm/saleRemind/followRemindList?selectDay=7">14日未跟进</a></li>
		<li class="active"><a href="${ctx}/crm/saleRemind/monthSaleFollowList?selectDay=16">1月未跟进</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="sale" action="${ctx}/crm/saleRemind/monthSaleFollowList?selectDay=16" method="post" class="breadcrumb form-search">
		<ul class="ul-form">
			<li>
				<label>意向业务：</label>
