...
<ul class="nav nav-tabs">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a href="${ctx}/crm/employeeGradeManager/getEmployeeInfo?id=${employee.id}">详细信息</a></li>
...
<form:form id="inputForm" modelAttribute="employee" action="${ctx}/crm/entry/saves" method="post" class="form-horizontal">
        ...
        <tr>
            <td>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <form:input path="education" htmlEscape="false" maxlength="50" class="input-large " readonly="true" style="width:210px;" value="${employee.highestEducation.commonsName}"/>
                    </div>
                </div>
            </td>
            <td>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="entry.code" htmlEscape="false" maxlength="50" class="input-large " readonly="true" style="width:210px;" value="${employee.entry.code}"/>

        </div>
    </div>
    <div class="alert alert-info">财务信息</div>
    <table id="contentTable" style="width:80%;">
        <tr>
            <td>
                <div class="control-group">
