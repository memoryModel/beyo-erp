...
<body>
	...
	<ul class="nav nav-tabs">
		<li class="active">
			<c:if test="${employeeLeave.category == 2}">
				<a href="${ctx}/crm/employeeOvertime/getEmployeeLeaveInfo?id=${employeeLeave.id}">加班审批</a>
			</c:if>
	...
	<form:form id="inputForm" modelAttribute="employeeLeave" action="${ctx}/crm/employeeLeave/agree" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<tr>
			...
			<td>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" value="${erp:getCommonsTypeName(employeeLeave.type)}" id="type" readonly="readonly" style="width: 200px;">
					</div>
				</div>
			</td>
		</tr>
			...
			<td>
				<div class="control-group">
					...
					<div class="controls">
						...
						<%--<form:radiobuttons path="status" items="${erp:employeeLeaveStatusList()}" itemLabel="name" itemValue="value" cssClass="required"/>--%>
