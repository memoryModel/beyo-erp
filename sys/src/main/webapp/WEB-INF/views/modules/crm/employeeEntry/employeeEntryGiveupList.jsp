...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/crm/employeeEntry/giveup/">放弃签约列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="entry" action="${ctx}/crm/employeeEntry/giveup" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="entry">
			<tr>
				...
				<td>
					<shiro:hasPermission name="crm:entry:info"><a href="${ctx}/crm/entry/view?id=${entry.id}">查看</a></shiro:hasPermission>
