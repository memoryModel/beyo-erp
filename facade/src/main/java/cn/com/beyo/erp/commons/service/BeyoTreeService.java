...
import cn.com.beyo.erp.commons.persistence.TreeBeyoDao;
...
public abstract class BeyoTreeService<D extends TreeBeyoDao<T>, T extends TreeVo<T>> extends BeyoService<D, T> {
